...
Airbrake.prototype.addRequestVars = function(request, type, vars) {
  ...
  Object.keys(vars).forEach(function(key) {
    ...
    try {
      ...
      console.trace('error creating addRequestVars xml node. value is: "' + value + '", error:', e);
    }
  });
};
...
Airbrake.prototype.cgiDataVars = function(err) {
  ...
  try {
    ...
    console.trace('Failed to call Object.keys on err. Error is:', JSON.stringify(err));
    cgiData['err.json'] = JSON.stringify(err);
  }
